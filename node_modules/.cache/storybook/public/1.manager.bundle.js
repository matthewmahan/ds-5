...
var ArrowSpacing = 8;
var Arrow = _storybook_theming__WEBPACK_IMPORTED_MODULE_36__[/* styled */ "n"].div({
  position: 'absolute',
  borderStyle: 'solid'
}, function (_ref6) {
  ...
  return {
    ...
    borderTopColor: match('top', placement, theme.color[color] || color || theme.base === 'light' ? Object(_storybook_theming__WEBPACK_IMPORTED_MODULE_36__[/* lighten */ "m"])(theme.background.app) : Object(_storybook_theming__WEBPACK_IMPORTED_MODULE_36__[/* darken */ "h"])(theme.background.app), 'transparent'),
    borderBottomColor: match('bottom', placement, theme.color[color] || color || theme.base === 'light' ? Object(_storybook_theming__WEBPACK_IMPORTED_MODULE_36__[/* lighten */ "m"])(theme.background.app) : Object(_storybook_theming__WEBPACK_IMPORTED_MODULE_36__[/* darken */ "h"])(theme.background.app), 'transparent'),
    borderLeftColor: match('left', placement, theme.color[color] || color || theme.base === 'light' ? Object(_storybook_theming__WEBPACK_IMPORTED_MODULE_36__[/* lighten */ "m"])(theme.background.app) : Object(_storybook_theming__WEBPACK_IMPORTED_MODULE_36__[/* darken */ "h"])(theme.background.app), 'transparent'),
    borderRightColor: match('right', placement, theme.color[color] || color || theme.base === 'light' ? Object(_storybook_theming__WEBPACK_IMPORTED_MODULE_36__[/* lighten */ "m"])(theme.background.app) : Object(_storybook_theming__WEBPACK_IMPORTED_MODULE_36__[/* darken */ "h"])(theme.background.app), 'transparent')
  };
});
var Wrapper = _storybook_theming__WEBPACK_IMPORTED_MODULE_36__[/* styled */ "n"].div(function (_ref8) {
  ...
  return hasChrome ? {
    background: theme.color[color] || color || theme.base === 'light' ? Object(_storybook_theming__WEBPACK_IMPORTED_MODULE_36__[/* lighten */ "m"])(theme.background.app) : Object(_storybook_theming__WEBPACK_IMPORTED_MODULE_36__[/* darken */ "h"])(theme.background.app),
...
var TargetContainer = _storybook_theming__WEBPACK_IMPORTED_MODULE_36__[/* styled */ "n"].div(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  display: inline-block;\n  cursor: ", ";\n"])), function (props) {
  return props.mode === 'hover' ? 'default' : 'pointer';
});
var TargetSvgContainer = _storybook_theming__WEBPACK_IMPORTED_MODULE_36__[/* styled */ "n"].g(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n  cursor: ", ";\n"])), function (props) {
  return props.mode === 'hover' ? 'default' : 'pointer';
